...
#include <bini_sensor_ros_plugins/Common.hh>
#include <ros/ros.h>
#include <std_msgs/Bool.h>
#include <bini_sensor_ros_plugins_msgs/ChangeSensorState.h>
...
namespace gazebo
{
  class ROSBasePlugin
  {
    ...
    protected: bool ChangeSensorState(
        bini_sensor_ros_plugins_msgs::ChangeSensorState::Request& _req,
        bini_sensor_ros_plugins_msgs::ChangeSensorState::Response& _res);
